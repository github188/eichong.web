...
public class ChannelManage {
	...
	private  Map<Channel,ECTcpClient> mapCh2Client = new ConcurrentHashMap<Channel, ECTcpClient>();
	private ConcurrentHashMap<String,ECTcpClient>  mapClients=new ConcurrentHashMap<String,ECTcpClient>();
