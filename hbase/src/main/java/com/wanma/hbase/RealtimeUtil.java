...
public class RealtimeUtil {
    ...
    public static List<Map<String, String>> getListByRowKey(String tablename, List<Filter> arr, List<String> columns, String startKey, String endKey)
    {
        return hbase.selectByRowKey(tablename, arr, columns, startKey, endKey);
    }

    public static Map<String, Object> getPageList(String tablename, List<Filter> arr, List<String> columns, long minStamp, long maxStamp, int startNum, int pageSize)
            throws Throwable
    {
        return hbase.selectByPageFilter(tablename, arr, columns, minStamp,
                maxStamp, startNum, pageSize);
    }
